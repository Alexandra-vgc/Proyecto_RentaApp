...
// Corregir iconos que no cargan por defecto en React Leaflet
...
const MapaInteractiva = ({ lat, lng, onLocationSelect, soloLectura = false }) => {
  ...
  return (
    <div style={{ height: '350px', width: '100%', borderRadius: '12px', overflow: 'hidden', border: '2px solid #C66A3D', zIndex: 0 }}>
      <MapContainer 
